...
class ChildNeedsAdapter extends RecyclerView.Adapter<ChildNeedsAdapter.Profile_ViewHolder> {
    ...
    @Override
    public ChildNeedsAdapter.Profile_ViewHolder onCreateViewHolder( ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder( ChildNeedsAdapter.Profile_ViewHolder vh, int i) {
