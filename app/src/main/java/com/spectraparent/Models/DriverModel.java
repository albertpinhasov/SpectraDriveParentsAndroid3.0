...
public class DriverModel {
        ...
        public void setVehicleImageUploadDocument(String vehicleImageUploadDocument){
            this.vehicleImageUploadDocument = vehicleImageUploadDocument;
        }
        public String getVehicleImageUploadDocument(){
            return this.vehicleImageUploadDocument;
        }
        ...
        public void setTrustedPersons(String trustedPersons){
            this.trustedPersons = trustedPersons;
        }
        public String getTrustedPersons(){
        ...
        public String getLearningCenterLocation(){
            return this.learningCenterLocation;
        }
